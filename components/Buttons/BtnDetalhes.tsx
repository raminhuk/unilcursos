...
const BtnDetalhes = ({ linkBtn }) => {
    return (
        <>
            <Link className="flex w-full max-lg:hidden" href={linkBtn} onClick={() => sendGAEvent({ event: 'clickCourseDetails', value: 'Mais detalhes - Massoterapia' })}>
